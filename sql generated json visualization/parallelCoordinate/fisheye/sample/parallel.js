...
var m = [90, 0, 10, 0],
    ...
    fisheye = d3.fisheye.scale(d3.scale.identity).domain([0,w]).focus(0).distortion(7),
    data,
    foreground,
    background,
    highlighted,
...
var colors = {
  ...
  "Fruits and Fruit Juices": [274,30,66],
...
d3.csv("nutrients-full.csv", function(raw_data) {
...
function data_table(sample) {
  ...
  var table = d3.select("#food-list")
    ...
    .enter().append("div")
      ...
      .on("click", function(d) {
        document.getElementById("sorted-by").innerHTML = "<h3>Dimensions sorted by</h3>";
